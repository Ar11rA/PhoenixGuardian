defmodule PhoenixGuardianWeb do
  ...
  def controller do
    quote do
      ...
      import PhoenixGuardianWeb.Gettext
    end
  end

  def view do
    quote do
      use Phoenix.View, root: "lib/phoenix_guardian_web/templates",
                        namespace: PhoenixGuardianWeb

      # Import convenience functions from controllers
      import Phoenix.Controller, only: [get_flash: 2, view_module: 1]

      import PhoenixGuardianWeb.Router.Helpers
      import PhoenixGuardianWeb.ErrorHelpers
      import PhoenixGuardianWeb.Gettext
    end
  end
